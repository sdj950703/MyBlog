					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
						    ...
						    <c:forEach items="${blogList }" var="blog">
						    	...
						    	<td><a class="btn btn-warning btn-sm" href="<%=path%>/blog/${blog.bId}"><span class="glyphicon glyphicon-pencil"></span>&nbsp;编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('确定删除吗？')" class="btn btn-danger btn-sm" href="<%=path%>/blog/${blog.bId}?method=deleteBlog"><span class="glyphicon glyphicon-remove"></span>&nbsp;删除</a></td>
						    	</tr>
						    </c:forEach>
						    </tbody>
						</table>
